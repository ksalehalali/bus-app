...
class CurrentWeatherController extends StateNotifier<AsyncValue<WeatherData>> {
  CurrentWeatherController(this._weatherRepository, {required String city}) : super(const AsyncValue.loading()) {
...
final currentWeatherControllerProvider = StateNotifierProvider.autoDispose.family<CurrentWeatherController, AsyncValue<WeatherData>, String>((ref, city) {
